...
/**
 * 処理 [SampleProcess]インタフェース。
 *
 * このインタフェースを継承して [blanco.sample.batchprocess]パッケージに[SampleProcess]クラスを作成して実際のバッチ処理を実装してください。<br>
 */
interface SampleProcess {
     ...
     */
    int execute(final SampleProcessInput input) throws IOException, IllegalArgumentException;
