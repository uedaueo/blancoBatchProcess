...
/**
 * 処理 [Sample2Process]インタフェース。
 *
 * このインタフェースを継承して [blanco.sample.batchprocess]パッケージに[Sample2Process]クラスを作成して実際のバッチ処理を実装してください。<br>
 */
interface Sample2Process {
    /**
     ...
     */
    int execute(final Sample2ProcessInput input) throws IOException, IllegalArgumentException;
